...
class Matrix_ToolBox{
    public:
        ...
        static std::vector<std::vector<double>> Matrix_Mul(std::vector<std::vector<float>> leftMx,
                                                           std::vector<std::vector<double>> rightMx);
        ...
        static std::vector<std::vector<double>> Matrix_Transpose(std::vector<std::vector<float>> Mx);
        ...
        static std::vector<double> Allocate_Vec_Vec_2F(int M);
        static std::vector<std::vector<double>> Allocate_Mx_Vec_2F(int M, int N);
        
        static void Clear_Matrix(std::vector<std::vector<int>> & Mx, int start);
        static void Clear_Matrix(std::vector<int> & Mx, int start);
        static void Clear_Matrix(std::vector<std::vector<float>> & Mx, float start);
        static void Clear_Matrix(std::vector<float> & Mx, float start);
        static void Clear_Matrix(std::vector<double> & Mx, double start);
